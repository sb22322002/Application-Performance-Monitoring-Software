...
cleanup(){
	...
	#############################################################
	kill $(ps | grep APM1 | awk '{print $1}') > /dev/null 2>&1
	kill $(ps | grep APM2 | awk '{print $1}') > /dev/null 2>&1
	kill $(ps | grep APM3 | awk '{print $1}') > /dev/null 2>&1
	kill $(ps | grep APM4 | awk '{print $1}') > /dev/null 2>&1
	kill $(ps | grep APM5 | awk '{print $1}') > /dev/null 2>&1
	kill $(ps | grep APM6 | awk '{print $1}') > /dev/null 2>&1
